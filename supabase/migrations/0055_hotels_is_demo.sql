...
-- Número 0055: renombrada desde 0051_hotels_is_demo.sql (PR #18) — 0051 ya
-- estaba ocupada en principal por 0051_authorized_room_change.sql (P0-3).
--
...
--   4. Recrea reset_demo_hotel() consultando por is_demo en vez de slug.
--      IMPORTANTE: la función se recrea a partir de la VERSIÓN MÁS RECIENTE
--      (la de 0054, última en tocarla — los fixes de FK 0053/0054 viven
--      ahí). La edición del archivo 0050 propuesta en el PR fue descartada:
--      migraciones ya aplicadas en producción no se editan (regla del repo);
--      el cambio va aquí como CREATE OR REPLACE (mismo patrón que 0040
--      sobre 0039).
--
...
-- reset_demo_hotel() con fuente de verdad is_demo (recrea la de 0054):
